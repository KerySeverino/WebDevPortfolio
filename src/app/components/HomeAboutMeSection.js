  ...
  return (
    <>
        ...
        <div className="min-h-screen pb-20">
            <div className="text-center text-responsive-size m-5">
                <h1>A LITTLE ABOUT ME</h1>
            </div>
            <div className="flex justify-center pb-20">
                <div className="m-4">
                    <Image className="img-responsive-size shadow:box-shadow rounded-3xl" src="/myself-2.png" alt="Coding Cartoon" width={256} height={256} />
                </div>
            </div>
