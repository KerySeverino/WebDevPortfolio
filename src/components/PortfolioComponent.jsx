            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 p-4 m-4 gap-4">
                <div className="portfolio-card-effect">
                    ...
                    <p className="mt-4">
                        ...
                        It is a live, evolving platform where I document my work, track my progress, and continuously implement 
                        new features as I refine my skills.  

                        Initially, I built this site using HTML, CSS, and JavaScript, but I have since migrated to React and Tailwind CSS 
                    ...
                    <div className="flex justify-center mt-4">
                        <img src="src/assets/self.jpg" className="rounded-full" width="70"/>
                    </div>
                    <p className="mt-4"> Kery | Mar 8, 2025 </p>
                </div>
                ...
                <div className="portfolio-card-effect">
                    ...
                    <div className="flex justify-center mt-4 img-hover-scale-effect">
                        <img src="src/assets/self.jpg" className="rounded-full" width="70"/>
                    </div>
